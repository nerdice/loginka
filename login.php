    ...
    <div class="login-card-container">
        <div class="login-card">
            <div class="login-card-logo">
                <a href="">NerdNetwork.</a>
            </div>
            <div class="login-card-header">
                <h1>Bejelentkezés</h1>
                <div>Kérlek jelentkezz be az oldal használatához!</div>
            </div>
            <form class="login-card-form" method="post" action="php/login_script.php">
                <div class="form-item">
                    <span class="form-item-icon material-symbols-rounded"></span>
                    <input type="text" placeholder="Add meg a felhasználónevet" id="emailForm" 
                    autofocus required name="fnev">
                </div>
                <div class="form-item">
                    <span class="form-item-icon material-symbols-rounded"></span>
                    <input type="password" placeholder="Add meg a jelszót" id="passwordForm"
                     required name="jelszo">
                </div>
                <div class="form-item-other">
                    <div class="checkbox">
                        <input type="checkbox" id="rememberMeCheckbox" checked>
                        <label for="rememberMeCheckbox">Emlékezz rá</label>
                    </div>
                    <a href="elfelejtettjelszo.html">Elfelejtetted a jelszavadat!</a>
                </div>
                <button type="submit">Bejelentkezés</button>
            </form>
            <div class="login-card-footer">
                Nincs fiókod? <a href="regisztracio.html">Csinálj egyet ingyen</a>
            </div>
        </div>
        <div class="login-card-social">
            <div>Nézz rá ezekre is:</div>
